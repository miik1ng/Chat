package com.mik1ng.network.errorhandler;
...
import com.mik1ng.network.bean.NeedLoginEvent;
import com.mik1ng.network.utils.ConvertUtils;
import com.mik1ng.network.utils.ToastUtils;
...
public class ExceptionHandle {
     ...
     * @return
     */
    public static ResponseThrowable handleException(Context context, Throwable throwable) {

        handError(context, throwable);
    ...
    private static void handError(Context context, Throwable e) {
        if (e instanceof HttpException) {
            ...
            try {
                if (response != null && response.errorBody() != null) {
                    ...
                    try {
                        bodyString = ConvertUtils.getResponseBodyString(response);
