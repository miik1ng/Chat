package com.mik1ng.network.environment;
...
public class NetworkEnvironmentActivity extends AppCompatActivity {
    ...
    public static class MyPreferenceFragment extends PreferenceFragmentCompat
        ...
        public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
            ...
            //设置缓存变化监听 ， 通过键来设置监听
            findPreference(NETWORK_ENVIRONMENT).setOnPreferenceChangeListener((androidx.preference.Preference.OnPreferenceChangeListener) this);
        }
